...
from src.get_real_estate_data.a_helper.config import links_paths, paths_helper, scrape_links_buy, scrape_links_rent
...
def scrape_all_cantons_properties(links_to_scrape: List) -> None:
    ...
    for link in links_to_scrape:
        my_driver = uc.Chrome()
        canton_name = link.split("/rent/apartment/")[1].split("/matching-list")[0]
...
scrape_all_cantons_properties(scrape_links_rent)
