...
from src.get_real_estate_data.helper.config import cantons, cantons_split_apartments
...
class LinkGenerator:
    ...
    def generate_all_links(self):
        ...
        for canton, values in self.canton_dict.items():
            base_url = f"https://www.homegate.ch/buy/apartment/canton-{canton}/matching-list?ipd=true"
